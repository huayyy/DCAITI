...
class Dataset(object):
    ...
    def __next__(self):
        with tf.device("/cpu:0"):
            ...
            classes = rtf.read_class_names("../data/classes/kitti.names")  # change the path
            new_dict = {v: k for k, v in classes.items()} # 反转字典，输出class number

            root_path = 'C:/Users/zicec/Documents/SS2021/DCAITI PJ/codes/data/kitti_tfrecords/'  # path to dir including converted tfrecord files
            ...
            if self.batch_count < self.num_batchs:
                while num < self.batch_size:
                    ...
                    image, bboxes = self.parse_annotation(iterator, new_dict)
                    (
                        label_sbbox,
                        label_mbbox,
                        label_lbbox,
    ...
    def parse_annotation(self, iterator, new_dict):
